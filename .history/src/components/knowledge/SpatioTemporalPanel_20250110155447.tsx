...
const predictionData = [
  { name: '2025-01-01', visitors: 5010 },
  { name: '2025-01-02', visitors: 3810 },
  { name: '2025-01-03', visitors: 4010 },
  { name: '2025-01-04', visitors: 3510 },
  { name: '2025-01-05', visitors: 2534 },
  { name: '2025-01-06', visitors: 4510 },
  { name: '2025-01-07', visitors: 5010 },
];
        ...
        <div className="popularity-trends">
          ...
          <div className="trend-visualization">
            ...
            >
              ...
              <Tooltip />
              <Legend />
              <Bar dataKey="春天" fill="#8884d8" />
              <Bar dataKey="冬天" fill="#82ca9d" />
              <Bar dataKey="夏天" fill="#ffc658" />
              <Bar dataKey="秋天" fill="#ff7300" />
            </BarChart>
          </div>
        </div>
      </div>
      ...
      <div className="predictive-analytics">
        ...
        <div className="prediction-results">
          ...
          >
            ...
            <YAxis />
            <Tooltip />
            <Area type="monotone" dataKey="游客总数" fill="#8884d8" stroke="#8884d8" />
          </AreaChart>
        </div>
      </div>
